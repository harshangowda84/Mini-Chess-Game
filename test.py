...
BOARD_SIZES = {
    "4x4": {"dim": 4, "pieces": ['b_B', 'b_K', 'b_Q', 'w_B', 'w_K', 'w_Q']},
    "6x6": {"dim": 6, "pieces": ['b_B', 'b_K', 'b_N', 'b_P', 'b_Q', 'w_B', 'w_K', 'w_N', 'w_P', 'w_Q']},
    "8x8": {"dim": 8, "pieces": ['b_B', 'b_K', 'b_N', 'b_P', 'b_Q', 'b_R', 'w_B', 'w_K', 'w_N', 'w_P', 'w_Q', 'w_R']}
}
CURRENT_BOARD_SIZE = "6x6"

# BG color
BACKGROUND = pygame.Color('azure')
BOARD_COLOR_A = pygame.Color('#F0D9B5')  # Light squares
BOARD_COLOR_B = pygame.Color('#B58863')  # Dark squares
HOVER_COLOR = pygame.Color('#DAA520')    # Golden hover color
...
def loadImages():
    ...
    IMAGES = {}
    pieces = BOARD_SIZES[CURRENT_BOARD_SIZE]["pieces"]
